...
public class CreateAction extends BaseAction {
    ...
    public long act(String name, long operatorId, String operands) {
        ...
        IndicatorEntity indicatorEntity = indicatorService.createOriginalIndicator(name, operatorId, operands);
        if (indicatorEntity == null) {
            throw new ServiceException("create indicator failed");
        }
        PlannedExpressionEntity plannedIndicator = indicatorService.createPlannedIndicator(indicatorEntity);
